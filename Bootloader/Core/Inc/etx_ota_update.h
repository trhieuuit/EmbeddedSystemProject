...
#define ETX_APP_SLOT0_FLASH_ADDR  0x08040000   //App slot 0 address
#define ETX_APP_SLOT1_FLASH_ADDR  0x08060000   //App slot 1 address
#define ETX_CONFIG_FLASH_ADDR     0x08010000   //Configuration's address

#define ETX_NO_OF_SLOTS           2            //Number of slots
#define ETX_SLOT_MAX_SIZE        (128 * 1024)  //Each slot size (128KB)
